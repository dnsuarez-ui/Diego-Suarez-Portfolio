...
export default function Contact() {
  ...
  return (
    <section id="contact" className="px-section-x py-section-y">
      <FadeUp>
        ...
        <FadeUp delay={0.1} className="flex-[0_1_min(100%,380px)]">
          <div className="flex items-center gap-12 min-w-0">
            <div className="flex items-center gap-1">
              <span className="group relative inline-block font-sans font-semibold text-body2 text-off-white pb-1">
                dnsuarez@gmail.com
